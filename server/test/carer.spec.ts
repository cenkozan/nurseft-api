...
describe('Carers', () => {
  ...
  describe('Backend tests for carers', () => {
    ...
    //
    // it('should create new carer', done => {
    //   const carer = new Carer ({firstName: 'John', lastName: 'Simpson', phone: '5553338976', email: 'johnsimpson@gmail.com',
    ...
    //
    // it('should create new carer', done => {
    //   const carer = new Carer ({firstName: 'Jane', lastName: 'Holland', phone: '5555691234', email: 'janeholland@hotmail.com',
    ...
    //     email: 'davedavid@gmail.com', phone: '7777777777', addressLine1: '141 NorthWood Way, London, HA6 1RF' });
  ...
  //       email: 'davedavid@gmail.com', addressLine1: '141 NorthWood Way, London, HA6 1RF' });
  //     carer.save((error, newCarer) => {
  //       chai.request(app)
